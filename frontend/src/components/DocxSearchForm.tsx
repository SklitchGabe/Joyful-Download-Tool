...
interface DocxSearchFormProps {
  onSearch: (params: ProjectSearchParams) => void;
}

function DocxSearchForm({ onSearch }: DocxSearchFormProps) {
  ...
  return (
    <div className="search-form docx-search-form">
      <h2>DOCX Document Search</h2>
      <p className="form-description">
        Enter one or more World Bank project IDs to find and download associated DOCX documents.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="search-button docx-search-button">Find DOCX Documents</button>
      </form>
    </div>
  );
}

export default DocxSearchForm; 